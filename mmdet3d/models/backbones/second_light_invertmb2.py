...
class SECOND_INVMB2(nn.Module):
    ...
    def __init__(self,
        ...
        super(SECOND_INVMB2, self).__init__()
        ...
        for i, layer_num in enumerate(layer_nums):
            ...
            for j in range(layer_num):
                block.append(build_conv_layer(conv_cfg, out_channels[i], out_channels[i], 3, padding=1, groups=out_channels[i])),
                block.append(build_norm_layer(norm_cfg, out_channels[i])[1]),
                block.append(build_conv_layer(conv_cfg, out_channels[i], out_channels[i], 1, padding=0)),
                block.append(build_norm_layer(norm_cfg, out_channels[i])[1])
