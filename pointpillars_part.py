...
if __name__ == "__main__":
    ...
    model_mmdet = torch.load("/home/mk/mmdetection3d-master/benchmark_model/pp_originSec/epoch_150.pth")
    ...
    # torch.onnx.export(model_pfn, (pillar_x, pillar_y, pillar_z, pillar_i, pfn_input_num_points, x_sub_shaped, y_sub_shaped, pfn_input_mask), "pfn.onnx", verbose=True, opset_version=11)
    ...
    # # torch.onnx.export(model_rpn, rpn_input, "rpn.onnx", verbose=True, opset_version=11)
